...
Public Module ProcessData
 ...
 Public StartTime As String
    ...
    DIM LblFileName as String =""

    Sub Main()
        MyDir = "."
        DBName = MyDir & "ROHData.Sql3"
        LblFileName = DBName
    ...
    Private Sub ExtractData() 
        ...
        while  CntStartRecord < CntEndRecord
            FileCount +=
            console.WriteLine("Start Person : " & FileCount.ToString & vbCrLf)
