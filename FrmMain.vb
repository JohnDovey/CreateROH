...
Public Class FrmMain
    ...
    Public Const sqlCreateLocality As String = "CREATE TABLE IF NOT EXISTS 'Locality' ('id' INTEGER NOT NULL,'LocalityID' INTEGER,'Locality' TEXT,PRIMARY KEY('id' AUTOINCREMENT));"
    ...
    Sub CheckDatabase(MyDbName)
        ...
        Using con As New SQLiteConnection(cs)
            ...
            Using cmd As New SQLiteCommand(con)
                ...
                cmd.ExecuteNonQuery()
                cmd.CommandText = sqlCreateLocality
                cmd.ExecuteNonQuery()
    ...
    Public Sub BtnExtractData_Click(sender As Object, e As EventArgs) Handles BtnExtractData.Click
        ...
        For FileCount = Val(CntStartRecord.Text) To Val(CntEndRecord.Text)
            ...
            If htmlNodes Is Nothing Then
                TxtLog.Text.Append("Record Skipped: " & FileCount)
            Else
                cnt = 0
